    ...
    <div className="min-h-screen bg-slate-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-14">
            <div className="flex items-center gap-4">
              ...
              <span className="text-slate-300">/</span>
              <span className="text-sm font-semibold text-slate-800">News Admin</span>
            </div>
            <div className="flex items-center gap-2">
              <Link to="/News">
                <Button variant="ghost" size="sm" className="rounded-full text-slate-500 text-xs">View News ↗</Button>
              </Link>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-6">
        <div>
          ...
          <p className="text-sm text-slate-400 mt-1">Manage company news, collections, and press coverage</p>
        </div>
          ...
          {isLoading ? (
            ...
            <>
              <div className="px-4 py-3 border-b border-slate-50">
                <p className="text-xs text-slate-400">{filtered.length} of {articles.length} articles</p>
              </div>
